...
----
$ git clone git@github.com:rmaddali/ttt
...
. Stop your booster.
. Make your change (e.g. edit link:https://github.com/rmaddali/ttt/edit/master/src/main/resources/webroot/index.html[`src/main/resources/webroot/index.html`]).
